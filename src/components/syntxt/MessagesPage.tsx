        ...
        <div className="shrink-0 border-t border-border bg-background p-3 safe-area-bottom">
          <div className="flex gap-2 items-end">
            <Input
              ...
              className="flex-1 rounded-full px-4 py-2 min-h-[40px] max-h-[120px]"
            />
            <Button 
              onClick={handleSendMessage} 
              disabled={!newMessage.trim()} 
              size="icon"
              className="rounded-full h-10 w-10 btn-bounce shrink-0"
            >
  ...
  return (
    <div className="pb-4 relative">
      ...
      <button
        ...
        className="fixed right-4 bottom-20 w-14 h-14 rounded-full bg-foreground text-background shadow-lg flex items-center justify-center hover:scale-105 active:scale-95 transition-transform z-30"
      >
